...
% 
%       sfigure(32); imagesc(real(poshidprobs)'); colormap gray; axis off;      
% 
%       yhid_ = poshidprobs*hidfac; %smoothed version
%       ypastA = past*pastfacA;     %summing over nt*numdims
%       
...
%       %undirected model
%       sfigure(35); 
%       subplot(2,1,1); hinton(real(visfac(1:maxdims,1:maxfac)));
%       subplot(2,1,2); hinton(real(hidfac(1:maxhid,1:maxfac)));
...
%       end      
%       subplot(2,1,1); hinton(real(pastrows));
%       subplot(2,1,2); hinton(real(visfacA(1:maxdims,1:maxfac)));
...
%       end     
%       subplot(2,1,1); hinton(real(pastrows));
%       subplot(2,1,2); hinton(real(hidfacB(1:maxhid,1:maxfac)));
%       set(gcf,'Name','directed')   
%       
%       %biases
%       sfigure(34);
%       subplot(2,1,1); hinton(real(visbiases(1:maxdims)));
%       subplot(2,1,2); hinton(real(hidbiases(1:maxhid)));
%       set(gcf,'Name','biases')
%       
%       
