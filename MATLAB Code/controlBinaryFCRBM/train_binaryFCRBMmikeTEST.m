function [ FCRBMConfig ] = train_binaryFCRBMmike(FCRBMConfig)
...
epsilonpastfacA=1e-3;   %Corresponding to the "directed" Autoregressive model
epsilonvisfacA=1e-3;
epsilonpastfacB=1e-2; %Corresponding to the "directed" past->hidden model
epsilonhidfacB=1e-2;
epsilonlabelfeat=1e-3;
epsilonvisbias=1e-2;
epsilonhidbias=1e-2;
...
%         
    ...
    negdata = (yfeat.*yhid)*visfac' + ...
      ...
      %%%%
       ...
       negdata = single(negdata2 > rand(numcases,numdims)); % didn't transpose negdata2....
       %%%%
      %%%%
      %%%
      %%%% %%%%
