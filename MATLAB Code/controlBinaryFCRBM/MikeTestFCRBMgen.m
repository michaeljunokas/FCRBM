function [ GenLog ] = MikeTestFCRBMgen ( FCRBM , InitData, labels, numframes, fr)
...
for tt=FCRBM.order+1:numframes
  ...
  for gg = 1:numGibbs
    ...
    visiblePROB = (yfeat.*yhid)*visfac' + constrecon;    
    visible(tt,:) = 1./(1 + exp(-visiblePROB));
...
%     pause(0.5);
  ...
  %Mean-field approx
  visiblePROB = (yfeat.*yhid_)*visfac' + constrecon;    
