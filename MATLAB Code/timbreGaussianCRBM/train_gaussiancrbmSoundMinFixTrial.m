function [ CRBMConfig ] = train_gaussiancrbmSoundMinFixTrial ( CRBMConfig )
...
epsilonw=1e-6;  %undirected
epsilonbi=1e-6; %visibles
epsilonbj=1e-6; %hidden units
epsilonA=1e-6;  %autoregressive
epsilonB=1e-6; 
