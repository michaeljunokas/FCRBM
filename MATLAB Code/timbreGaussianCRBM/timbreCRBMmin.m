...
% PLSTRAIN3 = mikeSTFT(rectPulseTrain3, FFTwindow, hop, tapWindow)';
  COMBO1 = mikeSTFT(combo1, FFTwindow, hop, tapWindow)';
  COMBO2 = mikeSTFT(combo2, FFTwindow, hop, tapWindow)';
% 
...
%%
 ...
 CRBM.classes{1,1}  = COMBO1;
  CRBM.classes{1,2}  = COMBO2;
%   CRBM.classes{1,3} = FREQMOD3;
...
CRBM = train_gaussiancrbmSoundMinFixTrial(CRBM);
...
classTested =1;
 ...
 numframes = 50; %how many frames to generate
